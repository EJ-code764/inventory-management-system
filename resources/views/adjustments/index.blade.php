<x-layouts.app title="Stock adjustments">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-muted">Auditable corrections for physical counts, damage, expiration, and other
                legitimate reasons.</p>
        </div>
        @can('create', \App\Models\StockAdjustment::class)
            <a href="{{ route('stock-adjustments.create') }}" class="btn-primary">New
                adjustment</a>
        @endcan
    </div>
