<div>
    <div class="mb-4 grid gap-4 rounded-xl bg-surface p-4 sm:grid-cols-3">
        ...
        <div><label for="movement-type" class="mb-1 block text-sm font-medium">Movement type</label><select
                id="movement-type" wire:model.live="type" class="w-full rounded-lg border border-border px-3 py-2">
    ...
    <p wire:loading role="status" class="mb-2 text-sm text-muted">Updating movement history…</p>
